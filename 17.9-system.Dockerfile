...
ARG postgresql_release=${postgresql_major}.9

# https://github.com/jedisct1/libsodium/releases
ARG libsodium_release=1.0.22
...
ARG pgsql_http_release=1.7.0

# https://github.com/okbob/plpgsql_check/releases
ARG plpgsql_check_release=2.8.11
